...
static mainmenu_group_factory g_mainmenu_group(g_mainmenu_group_id, mainmenu_groups::file, mainmenu_commands::sort_priority_dontcare);
...
public:
	...
	GUID get_command(t_uint32 p_index) {
		...
		static const GUID guid_open_torrent = { 0x0defd44a, 0x3e4f, 0x4abd, {0xa1, 0x67, 0xa1, 0x16, 0xff, 0xb9, 0xfb, 0x29} };

		switch(p_index) {
			/*case cmd_test: return guid_test;
			case cmd_playbackstate: return guid_playbackstate;*/
			case cmd_open_torrent: return guid_open_torrent;
	...
	void get_name(t_uint32 p_index,pfc::string_base & p_out) {
		switch(p_index) {
			...
			case cmd_open_torrent: p_out = "Open torrent..."; break;
			default: uBugCheck(); // should never happen unless somebody called us with invalid parameters - bail
		}
	}
	bool get_description(t_uint32 p_index,pfc::string_base & p_out) {
		switch(p_index) {
			...
			case cmd_open_torrent: p_out = "Loads playlist from a torrent."; return true;
			default: uBugCheck(); // should never happen unless somebody called us with invalid parameters - bail
		}
	}
	GUID get_parent() {
